...
(function() {
  ...
  window.renderMockTests = function(el) {
    ...
    <div style="display:flex;gap:8px;margin-bottom:16px;align-items:center;flex-wrap:wrap">
      <button class="btn btn-primary btn-sm anim-entrance" onclick="window.startCustomMockSetup()" style="--delay:0s">
        <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
        Create Custom Test
      </button>
      <button class="btn btn-ghost btn-sm anim-entrance" onclick="window.openAddMockTest()" style="--delay:0.05s">
