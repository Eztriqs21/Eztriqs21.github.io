...
function renderDashboard(el){
  ...
  el.innerHTML=`
  <div class="pg-hdr page-header anim-up"><div class="pg-title" data-text="Command Center">Command Center</div><div class="pg-sub">Your JEE preparation intelligence dashboard</div></div>
  <div class="stats-grid stagger">
    <div class="gc stat-card anim-up d1"><div class="stat-icon" style="background:var(--accent-dim)"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg></div><div class="stat-val stat-value"><span data-count="${active}">0</span></div><div class="stat-label">Active Tasks</div><div class="stat-sub">Pending assignments</div></div>
    <div class="gc stat-card anim-up d2"><div class="stat-icon" style="background:var(--phys-dim)"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg></div><div class="stat-val stat-value"><span data-count="${done}">0</span><span style="color:var(--muted);font-size:16px">/${total}</span></div><div class="stat-label">Chapters Done</div><div class="stat-sub">${safePct(done,total)}% complete</div></div>
    <div class="gc stat-card anim-up d3"><div class="stat-icon" style="background:var(--green-dim)"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg></div><div class="stat-val stat-value"><span data-count="${avg}">0</span>%</div><div class="stat-label">Avg Test Score</div><div class="stat-sub">Across ${tests.length} tests</div></div>
    <div class="gc stat-card anim-up d4"><div class="stat-icon" style="background:var(--chem-dim)"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div><div class="stat-val stat-value"><span data-count="${(+weekH).toFixed(1)}">0</span>h</div><div class="stat-label">This Week</div><div class="stat-sub">Today: <span data-count="${(+todayH).toFixed(1)}">0</span>h</div></div>
  </div>
  <div class="section-block anim-up d2">
    ...
    <div class="subj-progress-grid">
      ${[{n:'Physics',i:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',c:'var(--phys)',d:phD,t:DB.chapters.physics.length},{n:'Chemistry',i:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 3h6v11l4 5H5l4-5V3z"/><line x1="9" y1="3" x2="15" y2="3"/></svg>',c:'var(--chem)',d:chD,t:DB.chapters.chemistry.length},{n:'Mathematics',i:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 20L20 4"/><path d="M15 4h5v5"/><path d="M4 20l5-5"/></svg>',c:'var(--math)',d:mD,t:DB.chapters.maths.length}].map(s=>{
        ...
        return `<div class="gc chapter-card" style="padding:18px;cursor:pointer" onclick="go('chapters')">
          ...
          <div class="pbar-wrap progress-bar" style="height:5px"><div class="pbar progress-fill" style="height:5px;width:${p}%;background:${s.c}"></div></div>
  ...
  <div class="recent-grid anim-up d3">
    <div>
      ...
      <div class="gc chapter-card" style="padding:16px 18px">
