...
(function() {
  ...
  window.renderPYQ = function(el) {
    ...
    el.innerHTML = ''
      ...
      + '</div>'
      + '<div class="' + p + '-stat-card">'
      + '<div class="' + p + '-stat-icon" style="color:var(--phys)">' + SUBJECT_ICONS.maths + '</div>'
      + '<div class="' + p + '-stat-val" style="color:var(--phys)"><span data-count="' + subjectCounts.maths + '">0</span></div>'
